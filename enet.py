...
from keras.layers import Input, Conv2D, Conv2DTranspose, UpSampling2D, MaxPooling2D, concatenate, BatchNormalization, SpatialDropout2D, ZeroPadding2D, Permute, Add
